...
[8.6 Elasticgraph as datasource](./microservices/datasources/elasticgraph.md)   
    [8.6.1 Folder Structure](./microservices/datasources/elasticgraph.md/#851-folder-structure)   
    [8.6.2 Datasource DSL](./microservices/datasources/elasticgraph.md/#852-datasource-dsl)   
    [8.6.3 Configuration files for elasticgraph](./microservices/datasources/elasticgraph.md/#853-configuration-files-of-elasticgraph)   
    [8.6.4 Elasticgraph Setup](./microservices/datasources/elasticgraph.md/#854-elasticgraph-setup)   
    [8.6.5 Auto generating CRUD APIs for elasticgraph](./microservices/datasources/elasticgraph.md/#855-auto-generating-crud-apis-for-elasticgraph)   
...
[8.8 AWS as datasource](./microservices/datasources/aws.md)   
    [8.8.1 Example spec](./microservices/datasources/aws.md/#871-example-spec)   
    [8.8.2 com.gs.aws workflow](./microservices/datasources/aws.md/#872-comgsaws-workflow)   
