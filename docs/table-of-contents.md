...
[6. Events](./microservices/events.md)
    ...
    [6.2 Event schema & examples for supported sources](./microservices/events.md/#52-event-schema--examples-for-supported-sources)
        [6.2.1 JSON schema validation](./microservices/events/#621-json-schema-validation)
        [6.2.2 HTTP event](./microservices/events/#622-http-event)
        [6.2.3 Kafka event](./microservices/events/#623-kafka-event)
        [6.2.4 Salesforce Event](./microservices/events/#624-salesforce-event)
        [6.2.5 CRON event](./microservices/events/#625-cron-event)
